...
public class Week2Assignment4Image {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//driver.navigate().to(driver.findElement(By.xpath("(//div[@class='row']//img)[2]")).getAttribute("src"));
		
		//driver.findElement(By.xpath("(//div[@class='row']//img)[3]")).click();
